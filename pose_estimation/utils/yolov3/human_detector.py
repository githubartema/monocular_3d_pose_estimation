...
from .preprocess import prep_image as prep_image_imported
from .util import *

cur_dir = os.path.dirname(os.path.realpath(__file__))
model_dir = os.path.join(os.path.dirname(cur_dir), "data/")
...
def arg_parse():
    ...
    parser.add_argument(
        ...
        "--weight-file",
        type=str,
        default=os.path.join(model_dir, "yolov3.weights"),
...
def yolo_human_det(img, model=None, reso=416, confidence=0.70):
    ...
    img, ori_img, img_dim = prep_image_imported(img, inp_dim)
