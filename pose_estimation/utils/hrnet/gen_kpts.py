...
from .lib.utils import (PreProcess, get_final_preds, load_json, plot_keypoint,
                        write)

dir_path = os.path.dirname(os.path.realpath(__file__))
model_dir = cfg_dir = os.path.join(os.path.dirname(dir_path), "data/")

from ..sort.sort import Sort
# Loading human detector model
from ..yolov3 import load_model as yolo_model
from ..yolov3 import yolo_human_det as yolo_det
...
def get_keypoints_hrnet(video, det_dim=416, num_peroson=1, gen_output=False):
